  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 w-full pb-24 md:pb-16 animate-in fade-in duration-700 max-w-[1600px] mx-auto px-4 md:px-8 xl:px-0">
      ...
      <header className="flex flex-col gap-3 pt-4">
        ...
        {/* Mobile-Only Quick Actions Grid (Gojek-style) */}
        <MobileQuickActions />
      </header>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 lg:gap-10 items-start relative">
        ...
        <div className="xl:col-span-8 flex flex-col gap-10">
          ...
          {/* QUICK INFO (Mobile only, moved from sidebar) */}
          {isMobile && (
            <section className="flex flex-col gap-5">
               <LeaveBalanceCard />
               <QuickInfoCard />
          ...
          {/* REQUESTS & FORMS SECTION - Hidden or simplified on mobile if already in QuickActions */}
          {!isMobile && (
            <section className="flex flex-col gap-5">
              <div className="flex items-center gap-3 px-1">
