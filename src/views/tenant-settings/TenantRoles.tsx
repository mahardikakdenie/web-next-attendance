          ...
          <div className="space-y-3">
            {filteredRoles.length > 0 ? filteredRoles.map((role) => (
              <button
                ...
                className={`w-full flex items-center gap-4 p-5 rounded-[32px] transition-all duration-300 text-left border group ${selectedRoleId === role.id
              ...
              >
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 transition-colors ${selectedRoleId === role.id ? "bg-blue-600 text-white shadow-lg shadow-blue-500/30" : "bg-white text-slate-400 border border-slate-100 group-hover:bg-slate-50"
                  }`}>
        ...
        <div className="lg:col-span-8 bg-white rounded-[40px] shadow-sm border border-slate-100 flex flex-col min-h-[750px] overflow-hidden">
          ...
          {selectedRole ? (
              ...
              <div className="p-8 border-b border-slate-50 bg-slate-50/30">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Button
                      ...
                      className={`font-black px-8 py-4 rounded-2xl flex items-center gap-2 shadow-lg transition-all active:scale-95 uppercase text-[10px] tracking-widest ${isCurrentTabDirty
                ...
                <div className="flex p-1.5 bg-slate-100/80 rounded-2xl border border-slate-200/50 w-fit">
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 relative ${activeTab === "permissions" ? "bg-white text-blue-600 shadow-sm ring-1 ring-slate-200/50" : "text-slate-500 hover:text-slate-900"
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2 relative ${activeTab === "hierarchy" ? "bg-white text-blue-600 shadow-sm ring-1 ring-slate-200/50" : "text-slate-500 hover:text-slate-900"
                      }`}
                  >
                  ...
                  <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
                    <div className="bg-slate-900 rounded-[32px] p-8 text-white relative overflow-hidden shadow-2xl">
                      ...
                      <div className="relative z-10 flex items-center gap-6">
                        ...
                        <div>
                          <h3 className="text-xl font-black tracking-tight uppercase">HIERARCHY BUILDER</h3>
                        ...
                        <div className="space-y-2">
                          {roles.filter(r => r.id !== selectedRoleId).map(r => (
                            <button
                              ...
                              className={`w-full flex items-center justify-between p-4 rounded-2xl transition-all border ${childRoleIds.includes(r.id)
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-slate-400">
              ...
              <p className="font-black uppercase tracking-[0.3em] text-[10px] opacity-40">SELECT A ROLE TO CONFIGURE</p>
            </div>
          )}
