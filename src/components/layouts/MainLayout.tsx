import DraggableTimeTracker from "@/components/ui/DraggableTimeTracker";
...
import BillingHealthBanner from "@/components/ui/BillingHealthBanner";
...
export default function MainLayout({
  ...
  return (
    <div className="flex h-dvh w-full overflow-hidden bg-slate-50 font-sans selection:bg-blue-500/30 flex-col">
      <AuthBootstrap />
