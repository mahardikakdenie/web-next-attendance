...
type FilterStatus = "All" | "On Time" | "Late" | "Absent";
const FILTERS: FilterStatus[] = ["All", "On Time", "Late", "Absent"];
  ...
  return (
    <div className="bg-white rounded-[24px] border border-neutral-200 p-3 flex flex-col lg:flex-row gap-4 justify-between items-center shadow-sm">
      ...
      <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
        ...
        <div className="flex items-center gap-1 bg-neutral-100/50 p-1 rounded-[18px] border border-neutral-200/50">
